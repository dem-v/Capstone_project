...
\begin{Shaded}
	\begin{Highlighting}[fontsize=\footnotesize,fontfamily=courier]
		\NormalTok{wsl.}\FunctionTok{exe}\NormalTok{ {-}{-}cd /path/to/project python3}\NormalTok{ \textasciigrave{}} 
		\NormalTok{scripts/run\_improvementexperiment.}\FunctionTok{py}\NormalTok{ \textasciigrave{}}
