...
% Indent the FIRST paragraph after every chapter/section/subsection heading.
% LaTeX suppresses it by default; the template requires a 1.25 cm indent on
% all paragraphs. indentfirst neutralizes the suppression and works with
% titlesec (both honour the same \@afterindent flag).
